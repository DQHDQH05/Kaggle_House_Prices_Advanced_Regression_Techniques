...
df.isnull().sum()
##Seeems NA represent No_Alley
df['Alley'] = df['Alley'].replace(pd.NA, 'No_Alley')
##Seeems NA represent 0 LotFrontage
df['LotFrontage'] = df['LotFrontage'].fillna(0)
##Seems MSSubClass is int64 but should be string
...
data0.to_csv('C:/Users/Qihong/Box/1_Kaggle/Housing_Price_Prediction/preprocessed_Qu(1_20).csv', index=False, header=True)
